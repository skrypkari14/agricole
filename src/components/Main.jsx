                            ...
                            <div className='shrink-0 grow-0'>
                                <div className='w-[366px] w-[291px] relative'>
                                    ...
                                    <div className='circleSmall-green-2'>
                                        <img src={advert_car} alt='CAR' className='w-full h-full scale-75 translate-x-[5px]'/>
                                    </div>
                                    <div className='circleSmall-green-big'>
                                        <div className='circleSmall-green-3'>
                                            <img src={eco} alt='ECO' className='w-full h-full scale-[0.6] translate-x-[5px] -translate-y-[10px]'/>
                                        </div>
                                        <img src={eco_case} alt='ECO_CASE' className='ecoCase'/>
                                    </div>
                                </div>
                            </div>
                        </div>
